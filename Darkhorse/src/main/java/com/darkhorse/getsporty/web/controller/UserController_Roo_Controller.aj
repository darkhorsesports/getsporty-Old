...
privileged aspect UserController_Roo_Controller {
    ...
    @Autowired
    UserSvc UserController.userSvc;
    
    @Autowired
    UserRoleSvc UserController.userRoleSvc;
    ...
    public String UserController.show(@PathVariable("id") BigInteger id, Model uiModel) {
        ...
        uiModel.addAttribute("user", userSvc.findUser(id));
    ...
    public String UserController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("users", userSvc.findUserEntries(firstResult, sizeNo));
            float nrOfPages = (float) userSvc.countAllUsers() / sizeNo;
    ...
    public String UserController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, userSvc.findUser(id));
        return "users/update";
    }
    ...
    void UserController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("user_created_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
